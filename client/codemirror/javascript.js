...
CodeMirror.defineMode('javascript', function (config, parserConfig) {
  ...
  var keywords = (function () {
    ...
    var A = kw('keyword a'); var B = kw('keyword b'); var C = kw('keyword c'); var D = kw('keyword d')
  ...
  function readRegexp (stream) {
    var escaped = false; var next; var inSet = false
  ...
  function findFatArrow (stream, state) {
    ...
    var depth = 0; var sawSomething = false
